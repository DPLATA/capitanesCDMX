...
capitanes_fourfactors_06mar23 <- read.csv('data/capitanes_vs_gogo_06mar23_fourfactors.csv')

#Generate a gt table from head of data
head(capitanes_fourfactors_06mar23) %>% 
  gt()

(ff_table <- head(capitanes_fourfactors_06mar23) %>% 
    gt() %>%
